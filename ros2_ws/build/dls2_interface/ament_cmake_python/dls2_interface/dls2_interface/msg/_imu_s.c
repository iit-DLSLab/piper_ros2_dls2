...
bool dls2_interface__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dls2_interface.msg._imu.Imu", full_classname_dest, 27) == 0);
  }
  dls2_interface__msg__Imu * ros_message = _ros_message;
  {  // frame_id
  ...
  {  // orientation_rpy
    PyObject * field = PyObject_GetAttrString(_pymsg, "orientation_rpy");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 3;
      double * dest = ros_message->orientation_rpy;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * dls2_interface__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dls2_interface.msg._imu");
  ...
  {  // orientation_rpy
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "orientation_rpy");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->orientation_rpy[0]);
