...
bool dls2_interface__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dls2_interface.msg._pose.Pose", full_classname_dest, 29) == 0);
  }
  dls2_interface__msg__Pose * ros_message = _ros_message;
  {  // position
...
PyObject * dls2_interface__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dls2_interface.msg._pose");
