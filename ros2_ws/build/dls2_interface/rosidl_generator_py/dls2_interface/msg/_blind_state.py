...
class Metaclass_BlindState(type):
    """Metaclass of message 'BlindState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dls2_interface.msg.BlindState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__blind_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__blind_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__blind_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__blind_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__blind_state
...
class BlindState(metaclass=Metaclass_BlindState):
    """Message class 'BlindState'."""
    ...
    _fields_and_field_types = {
        ...
        'feet_contact': 'sequence<boolean>',
        'current_feet_positions': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.feet_contact = kwargs.get('feet_contact', [])
        self.current_feet_positions = array.array('d', kwargs.get('current_feet_positions', []))
    ...
    def __eq__(self, other):
        ...
        if self.joints_temperature != other.joints_temperature:
            return False
        if self.feet_contact != other.feet_contact:
            return False
        if self.current_feet_positions != other.current_feet_positions:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'feet_contact' field must be a set or sequence and each value of type 'bool'"
    ...
    def current_feet_positions(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'current_feet_positions' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'current_feet_positions' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._current_feet_positions = array.array('d', value)
