...
#ifndef DLS2_INTERFACE__MSG__DETAIL__CONTROL_SIGNAL__TRAITS_HPP_
#define DLS2_INTERFACE__MSG__DETAIL__CONTROL_SIGNAL__TRAITS_HPP_
...
inline void to_yaml(
  const dls2_interface::msg::ControlSignal & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dls2_interface::msg::ControlSignal & msg)
{
  return dls2_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dls2_interface::msg::ControlSignal>()
{
  return "dls2_interface::msg::ControlSignal";
}

template<>
inline const char * name<dls2_interface::msg::ControlSignal>()
{
  return "dls2_interface/msg/ControlSignal";
}

template<>
struct has_fixed_size<dls2_interface::msg::ControlSignal>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dls2_interface::msg::ControlSignal>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<dls2_interface::msg::ControlSignal>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DLS2_INTERFACE__MSG__DETAIL__CONTROL_SIGNAL__TRAITS_HPP_
