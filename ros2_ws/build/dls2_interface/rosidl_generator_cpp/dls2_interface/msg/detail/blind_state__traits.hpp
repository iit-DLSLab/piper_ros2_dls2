...
#ifndef DLS2_INTERFACE__MSG__DETAIL__BLIND_STATE__TRAITS_HPP_
#define DLS2_INTERFACE__MSG__DETAIL__BLIND_STATE__TRAITS_HPP_
...
inline std::string to_yaml(const BlindState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dls2_interface::msg::BlindState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dls2_interface::msg::BlindState & msg)
{
  return dls2_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dls2_interface::msg::BlindState>()
{
  return "dls2_interface::msg::BlindState";
}

template<>
inline const char * name<dls2_interface::msg::BlindState>()
{
  return "dls2_interface/msg/BlindState";
}

template<>
struct has_fixed_size<dls2_interface::msg::BlindState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dls2_interface::msg::BlindState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<dls2_interface::msg::BlindState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DLS2_INTERFACE__MSG__DETAIL__BLIND_STATE__TRAITS_HPP_
